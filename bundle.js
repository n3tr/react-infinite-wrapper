...
/***/ function(module, exports, __webpack_require__) {
	...
	var DribbbleView = __webpack_require__(1);
	var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(159);

	ReactDOM.render(React.createElement(DribbbleView, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfiniteWrapper = __webpack_require__(160);
	var ShotPreviewItem = __webpack_require__(161);

	var DribbbleView = React.createClass({
	  displayName: 'DribbbleView',

	  render: function render() {
	    var shotPreviews = [];
	    for (var i = 0; i < 1000; i++) {
	      shotPreviews.push(React.createElement(ShotPreviewItem, { key: i }));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfiniteWrapper = React.createClass({
	  ...
	  calculateRenderState: function calculateRenderState() {
	    var firstIndex = 0;
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'cf', ref: 'infiniteWrapper', style: style },
	      inScreenChilden
	    );
	  }
	...
	var ShotPreviewItem = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'shot-preview--content' },
	        React.createElement(
	          'div',
	          { className: 'shot-preview--image' },
	          React.createElement('img', { src: 'https://d13yacurqjgara.cloudfront.net/users/417531/screenshots/2339037/day2_small_1x.png' })
	        ),
	        React.createElement(
	          'h2',
	          { className: 'shot-preview--title' },
	          'Hello'
	        )
	      )
	    );
